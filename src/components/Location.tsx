            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-2 text-sm">
                <a
                  ...
                  className="inline-flex items-center gap-2 font-semibold text-ink transition hover:text-orange-dark"
                >
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 text-ink/70 transition hover:text-orange-dark"
                >
                  <svg aria-hidden viewBox="0 0 24 24" className="h-4 w-4 fill-none stroke-current stroke-[1.8]">
              ...
              <table className="w-full border-collapse text-sm">
                <tbody>
                  {HOURS.map((row) => (
                    <tr key={row.day} className="border-t border-dashed border-smoke/12">
                      <td className="py-2 text-ink/70">{row.day}</td>
